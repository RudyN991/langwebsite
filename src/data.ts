    ...
    subpages: [
      {
        ...
        commentary: [
          "Neil deGrasse Tyson spends the majority of the book discussing common topics and discoveries that humans have made concerning space and how they connect to earthly science topics. He highlights the advancement of human understanding of the universe from previous models to modern models and how development in technology has advanced. Through this he highlights the developments that science and space exploration have led to from updated understandings of the world around us, to advanced models of physics that have led to the development of new technologies. Tyson's discussions and examples support the benefits of space exploration and how humanity has benefitted from their ventures into the stars with examples of information that we have gained from various missions and developments in astrospace. Overall, Tyson's argument supports the importance of space exploration and continuing curiosity by supporting the good that has come about and the benefits it has provided to humanity.",
        ],
      },
    ],
  },
